...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeConfig = __webpack_require__(12);
	...
	_store2['default'].dispatch(_store2['default'].actions.init(_functionsInit2['default']()));
	// install router
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _functionsHash_filter = __webpack_require__(57);

	var _functionsHash_filter2 = _interopRequireDefault(_functionsHash_filter);

	var _functionsHash_update = __webpack_require__(58);
	...
	function configRouter(router) {
	  ...
	  router.afterEach(function (transition) {
	    var filter = _functionsHash_filter2['default']();
	    history.replaceState({}, '', location.pathname + filter.path);
	  });
	}

	window.onhashchange = function () {
	  var last_url = _functionsHash_update.hash_store();

	  var filter = _functionsHash_filter2['default']();
	  var _filter = _functionsHash_filter2['default'](last_url.href, []);

	  if (_filter.plus.length > filter.plus.length) {
	    _store2['default'].dispatch(_store2['default'].actions.plu_hide(_filter.plus[0]));
	  } else if (filter.plus.length > _filter.plus.length) {
	    _store2['default'].dispatch(_store2['default'].actions.plu_show(filter.plus[0]));
	  }
	  last_url.update();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsTodos = __webpack_require__(54);

	var actions = _interopRequireWildcard(_actionsTodos);

	var createStoreWithMiddleware = _redux.applyMiddleware(_reduxThunk2['default'])(_redux.createStore);

	var reduxStore = createStoreWithMiddleware(_reducersApp2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {// to valid and match like `a as x.y.z`
	'use strict';
	...
	function parseProp(prop) {
	    ...
	    if (re.test(prop)) {
	        ...
	        storeProp = _prop$match[1];
	        realProp = _prop$match[2];
	    }
	                ...
	                var handleChange = function handleChange() {
	                    _this._bindProps.forEach(function (prop) {
	                        ...
	                        if (realProp && storeProp) {
	                            _this.$set(realProp, deepProp(store.getState(), storeProp));
	                        }
	                    });
	                };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(29)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _elong = __webpack_require__(36);

	var _elong2 = _interopRequireDefault(_elong);

	var _layer = __webpack_require__(51);

	var _layer2 = _interopRequireDefault(_layer);

	var _plugin = __webpack_require__(52);

	var _plugin2 = _interopRequireDefault(_plugin);

	exports['default'] = _redux.combineReducers({
	  elong: _elong2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	function layer(layer, action) {
	  if (layer === undefined) layer = defaultLayer;

	  switch (action.type) {
	    case 'LOADING_MASK':
	      return _Object$assign({}, layer, {
	        mask: true,
	        loading: true,
	        cover: false
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function layer(plus, action) {
	  if (plus === undefined) plus = defaultPlus;
	  ...
	  switch (action.type) {
	    case 'PLU_ADD':
	      ...
	      return _Object$assign({}, plus, plu);

	    case 'PLU_SHOW':
	      plus[action.name].show = true;
	      return _Object$assign({}, plus, {});
...
/***/ function(module, exports) {
	...
	exports['default'] = function (_location, _ignored) {

	  var hash = [],
	      url = '',
	      ignored = _ignored || ['plu'],
	      hash_url = '',
	      packed = {},
	      plus = [],
...
/***/ function(module, exports) {
	...
	exports.__esModule = true;
	exports.hash_add = hash_add;
	exports.hash_pop = hash_pop;
	var hash_store = (function () {
	  function single() {
	    this.href = '', this.update = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var id = "-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./not-found.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./not-found.vue"], function () {
	var newOptions = null
	var newTemplate = require("-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./not-found.vue")
...
/***/ function(module, exports) {
	...
	module.exports = "<p>FOUND NOT FOUND</p>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-52207d9c&file=index.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-52207d9c&file=index.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSectionSlideVue = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./section-slide.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./section-slide.vue","-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./section-slide.vue"], function () {
	var newOptions = require("-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./section-slide.vue")
	var newTemplate = require("-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./section-slide.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2875538b&file=section-slide.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./section-slide.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2875538b&file=section-slide.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./section-slide.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-6073ccf6&file=app.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-6073ccf6&file=app.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  components: {
	    masklay: _pluginMasklayVue2['default']
	  },
	  ready: function ready() {
	    var transitioner = new _structorTransitionerVue2['default']({});
	    transitioner.$mount('#transitioner');
	  }
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./masklay.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./masklay.vue","-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./masklay.vue"], function () {
	var newOptions = require("-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./masklay.vue")
	var newTemplate = require("-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./masklay.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3630dfd2&file=masklay.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./masklay.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3630dfd2&file=masklay.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./masklay.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./transitioner.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./transitioner.vue","-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./transitioner.vue"], function () {
	var newOptions = require("-!babel-loader?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./transitioner.vue")
	var newTemplate = require("-!vue-html-loader!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./transitioner.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2568868e&file=transitioner.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./transitioner.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2568868e&file=transitioner.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./transitioner.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
